	...
	return (
		<>
			<button className='btn' onClick={showModal}>
				<i class='icon material-symbols-outlined'>add_circle</i>
        <label>New Transaction</label>
			...
			>
				...
				<Form form={form} layout="vertical" labelWrap onFinish={handleOnFinish}>
					<Form.Item label='Transaction Name' name='title' required>
						<Input />
					</Form.Item>
					<Form.Item label='Transaction Type' name='type' required>
